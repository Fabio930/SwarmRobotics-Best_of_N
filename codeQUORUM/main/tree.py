...
class Tree:
    ...
    def adjust_arena(self,branches,ref=None):
        ...
        if self.child_nodes[0] is None:
            ...
            for k in range(np.random.choice([1,2,3])):
    ...
    def arrange_root_kernel(self):
        ...
        self.gaussian_kernel = st.maximum_filter(self.gaussian_kernel,size=Tree.std)
        self.gaussian_kernel = st.uniform_filter(self.gaussian_kernel,size=Tree.std)
