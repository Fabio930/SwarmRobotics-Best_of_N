...
class Vec2d(object):
    ...
    def isin(self,tl,br):
        if self.__getitem__(0)>=tl.__getitem__(0) and self.__getitem__(0)<=br.__getitem__(0):
            if self.__getitem__(1)>=tl.__getitem__(1) and self.__getitem__(1)<=br.__getitem__(1):
                return True
        return False
